...
create table recipe (id bigint not null auto_increment, cook_time integer not null, description varchar(255), difficulty varchar(255), directions longtext, image tinyblob, preparation_time integer not null, servings integer not null, source varchar(255), url varchar(255), notes_id bigint, primary key (id)) ENGINE=InnoDB
...
create table unit_of_measure (id bigint not null auto_increment, unit_of_measure varchar(255), primary key (id)) ENGINE=InnoDB
